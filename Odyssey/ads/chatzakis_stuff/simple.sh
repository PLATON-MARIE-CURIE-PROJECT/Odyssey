...
#mpirun ../bin/ads --dataset /gpfs/scratch/chatzakis/data_size1B_sift_len128_znorm.bin --leaf-size 2000 --initial-lbl-size 2000 --min-leaf-size 2000 --dataset-size 300000000 --flush-limit 1000000 --function-type 9990 --in-memory --queries /gpfs/scratch/chatzakis/queries_size100_sift_len128_znorm.bin --queries-size 100 --read-block 20000 --timeseries-size 128 --index-workers 16 --query-workers 64 --query-mode 19 ### initial BSF
#mpirun ../bin/ads --dataset /gpfs/scratch/chatzakis/base.1B.bin --leaf-size 2000 --initial-lbl-size 2000 --min-leaf-size 2000 --dataset-size 200000000 --flush-limit 1000000 --function-type 9990 --in-memory --queries /gpfs/scratch/chatzakis/query.public.100K.bin --queries-size 1000 --read-block 20000 --timeseries-size 200 --index-workers 16 --query-workers 64 --query-mode 19 ### initial BSF


#! Benchmark query predictions (astro,deep)
#mpirun ../bin/ads --dataset /gpfs/scratch/chatzakis/data_size270M_astronomy_len256_znorm.bin --leaf-size 2000 --initial-lbl-size 2000 --min-leaf-size 2000 --dataset-size 200000000 --flush-limit 1000000 --function-type 9990 --in-memory --queries /gpfs/scratch/chatzakis/queries_ctrl100_astronomy_len256_znorm.bin --queries-size 100 --read-block 20000 --timeseries-size 256 --index-workers 16 --query-workers 64 --query-mode 0
#mpirun ../bin/ads --dataset /gpfs/scratch/chatzakis/data_size1B_deep1b_len96_znorm.bin --leaf-size 18000 --initial-lbl-size 18000 --min-leaf-size 18000 --dataset-size 400000000 --flush-limit 1000000 --function-type 9990 --in-memory --queries /gpfs/scratch/chatzakis/queries_ctrl100_deep1b_len96_znorm.bin --queries-size 100 --read-block 20000 --timeseries-size 96 --index-workers 16 --query-workers 64 --query-mode 0 ### initial BSF
...
mpirun ../bin/ads --dataset /gpfs/scratch/chatzakis/data_size100M_seismic_len256_znorm.bin --dataset-size 100000000 --leaf-size 2000 --initial-lbl-size 2000 --min-leaf-size 2000 --flush-limit 1000000 --function-type 9990 --in-memory --queries /gpfs/scratch/chatzakis/queries_ctrl100_seismic_len256_znorm.bin --queries-size 100 --read-block 20000 --timeseries-size 256 --index-workers 16 --query-workers 64 --query-mode 27 ### initial BSF
